...
router.post("/readFromUserID", wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
    let ra = req.body.ra;
    let a = yield AchievementUsuario.readFromUserID(ra);
    res.json(a);
})));
router.post("/readMissingAchievements", wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
    let ra = req.body.ra;
    let a = yield AchievementUsuario.readMissingAchievements(ra);
    res.json(a);
})));
router.post("/readFeaturedAchievements", wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
    let ra = req.body.ra;
