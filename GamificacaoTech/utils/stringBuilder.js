...
module.exports = class StringBuilder {
    static bookSpiller(p, nome, id) {
        ...
        for (let i = 0; i < n2; i++) {
            respString += '<div class="book"><div class="book-overlay"><p class="book-name">' + nome + '</p><p class="book-edition">II</p></div><div class="book-color"></div>';
        }
        respString += '</div><div class="book-group-3">';
        for (let i = 0; i < n3; i++) {
            respString += '<div class="book"><div class="book-overlay"><p class="book-name">' + nome + '</p><p class="book-edition">III</p></div><div class="book-color"></div>';
        }
        respString += '</div></div>';
        return respString;
    }
